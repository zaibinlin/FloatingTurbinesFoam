...
int main(int argc, char *argv[])
{
    ...
    //add - creates the exchange dictionary in the registry - Ur
    //from sixdofrigidbodymotionsolver.C - Line 322 - transport Ur
    //可以传输vector，volvectorfield不可以
...
/*
           ...
           //add - open and write - U->UR - be uesd in UEqu.H
	   const dictionary& dbDictionary = 
		runTime.lookupObject<IOdictionary>("motion");
   
	   //volVectorField UR = dbDictionary.lookupOrDefault<volVectorField>("UR",UR) ;
	   //Info << "URURURUR=" << UR << endl;
	   ...
	   //Info << "Md="<<Md<< endl;
	   //Info << "Linear_vel_="<<Linear_vel_<< endl;
	   //Info << "Angular_vel_="<<Angular_vel_<< endl;
...
//	     	   
	   ...
	   forAll(cells, i)
	       ...
	       //Info << "bi ="<<UR[cells[i]][0]/(U[cells[i]][0]+0.000000001)<< endl;
	   };
